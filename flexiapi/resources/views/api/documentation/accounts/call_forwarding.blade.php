...
* `type` **required**, must be `always`, `no_answer` or `busy`, one of each declaration maximum per account
...
* `enabled` **required**, boolean. If `type: always` is enabled `no_answer` and `busy` must be disabled. If `type: no_answer or busy` are enabled `always` must be disabled.
